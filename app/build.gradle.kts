...
android {
    namespace = "com.jamirodev.horoscopoapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.jamirodev.horoscopoapp"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    buildTypes {
        getByName("release") {
            ...
            resValue("string", "Jamironame", "Horoscapp")
            buildConfigField("String", "BASE_URL", "\"https://newastro.vercel.app/\"")
        }
        getByName("debug") {
            isDebuggable = true
            resValue("string", "Jamironame", "[DEBUG] Horoscapp")
